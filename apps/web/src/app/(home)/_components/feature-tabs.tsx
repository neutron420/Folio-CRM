      ...
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        ...
        <div className='grid items-end gap-8 md:grid-cols-2 md:gap-12'>
          <h2 className='text-balance font-bold text-4xl text-foreground tracking-tight md:text-5xl'>
            Why teams choose Folio CRM over spreadsheets
          </h2>
          <p className='max-w-md text-base text-muted-foreground leading-relaxed'>
            Stop managing workflows and tasks across scattered spreadsheets. Folio CRM keeps your projects, boards, team activity, and client pipelines connected in real time.
          </p>
        </div>
